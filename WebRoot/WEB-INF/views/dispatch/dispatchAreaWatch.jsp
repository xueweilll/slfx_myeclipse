			...
			<table>
				<tr>
					<td><label for="code">分解单编号:</label> <input id="id"
						...
						style="width:200" /></td>
					<td><label for="receiptId">调度令编号:</label> <input id="receiptid"
						data-options="required:true,disabled:true" value="${code}" style="width:200" /></td>
				...
				<tr>
					...
					<%-- <td><label for="promotetime">调度发起时间:</label> <input
		...
		$(function() {
			...
			if (aaa != "") {
				$('#instructions')
						.datagrid(
								{
									url : "dispatchAreaList/instructions.html?id="
											+ aaa
								});
				$('#stations')
						.datagrid(
								{
									url : "dispatchAreaList/stations.html?id="
											+ aaa
								});
			}
		...
		function save(obj){
			...
			if(endEditing1()){
				for(var i=0;i<instructions.length;i++){
					...
					if(instruction1=="关闸" && instruction2=="不操作"){
						...
						receiptDispatchInstructions.push({"instruction":"2","unitoperatetime":unitoperatetime});
						instructiones[i]="2";
						...
						receiptDispatchInstructions.push({"instruction":"4","gateoperatetime":gateoperatetime,"unitoperatetime":unitoperatetime});
						instructiones[i]="4";
						gateoperatetimes[i]=gateoperatetime;
						unitoperatetimes[i]=unitoperatetime;
			...
			if(endEditing2()){	
				for(var i=0;i<stations.length;i++){
					...
					stations1.push({"sid":stations[i].id});
				}

	...
	<form id="ffgate" method="post"
		...
		<table cellpadding="0" cellspacing="5" border="0">
			...
			<tr>
				...
				<td><input id="DispatchAccessorys" class="easyui-textbox"
					name="DispatchAccessorys" style="width: 200px; float: left;"
					value="${fileaddress}" data-options="disabled:true" /> <label
					style="width: 40px; float: right;display:none;" id="downAccessory"
					class="easyui-linkbutton">下载</label></td>
			</tr>
			<tr>
				<td></td>
			</tr>
			...
			<tr>
				...
				<td><input id="Receipter" name="Receipter"
					style="width: 250px;" class="easyui-textbox"
					data-options="disabled:true"
					value="${receipt.getReceipteUser().getUsername()}" /></td>
			</tr>
			...
			<tr>
				...
				<td><input class="easyui-textbox" id="aduitmemo"
					data-options="multiline:true" style="width: 250px; height: 60px;"
					value="${receipt.getAduitmemo()}" /></td>
			</tr>
		</table>
		<div id="btn" style="text-align: left;">
			<a id="aduit" href="javascript:void(0)" class="easyui-linkbutton"
				style="margin-left: 140px" data-options="iconCls:'icon-save'">结束</a><a
				id="can" href="javascript:void(0)" class="easyui-linkbutton"
				style="margin-left: 20px" data-options="iconCls:'icon-cancel'">取消</a>
		</div>
	</form>
	<script type="text/javascript">
		$(function() {
			...
			$("#aduit").bind("click", function() {
				...
				$.ajax({
					type : "POST",
					url : "dispatchAreaEDEnd/end.html",
					dataType : "text",
					data : {
						"id" : $("#Id").val()
					},
			...
			$("#downAccessory")
					.bind(
							"click",
							function() {
								var link = "dispatchAreaEDEnd/downAccessory.html?filename="
										+ myEncoder($("#Accessory").val());
		...
		function reflush() {
			document.getElementById('dispatchAreaEDEnd.htmlifm').contentWindow

...
<body>
	...
	<form id="addsdexecute" method="post"
		...
		<table>
			...
			<tr>
				...
				<td><input id="executer" style="width:320px;" data-options="required:true"/></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input id="memo" class="easyui-textbox" name="memo" style="width:320px;height:100px;" data-options="multiline:true" value="${sde.getMemo()}"/></td>
			</tr>
		</table>
		...
		<div id="btn" style="text-align: center">
			...
			<a id="commit" href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-save'" onclick="save2()">保存并提交</a>&nbsp;&nbsp;				
			<a id="cancle" href="javascript:void(0)" class="easyui-linkbutton"  data-options="iconCls:'icon-cancel'">取消</a>
		</div>
	</form>
	...
	<script type="text/javascript">
		...
		function onEndEdit2(index, row) {
			...
			if(row.sid != $(ed1.target).combobox('getValue')){
			...
			var value = $(ed2.target).combobox('getValue');

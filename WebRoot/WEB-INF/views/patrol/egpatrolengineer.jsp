...
<script type="text/javascript">
	$(function() {
		...
		$("#egpatrolengineerlist").datagrid({
			...
			collapsible : false,
			fit : true,
			url : 'egpatrolengineer/egpatrolengineerlist.html',
			queryParams : {
				type : "0",
				typeDate : "0"
			},
			...
			onDblClickRow:function(index,row){
				showDialogWH("工程科分解任务","egpatrolengineer/egpatrolengineerInfoHide.html?id=" + row.id,550, 600);
		...
		$("#send").bind("click",function() {
			...
			/* }else if(row.!="0") {
				...
				showDialogWH("工程科分解任务","egpatrolengineer/egpatrolengineerInfo.html?id=" + row.id,550, 650);
		  	}  
		});

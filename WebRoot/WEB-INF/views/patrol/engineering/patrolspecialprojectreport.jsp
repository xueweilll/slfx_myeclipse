...
<script type="text/javascript">
	...
	function commit(){
		...
		showDialogWH("提交签发单", "psprojectreport/patrolspecialprojectreportInfo.html?isId=" + row.id+"&type=1",670,590);
	}
	function searchInfo(row){
		showDialogWH("查看签发单明细", "psprojectreport/patrolspecialprojectreportInfo.html?isId=" + row.id+"&type=0",670,590);
	}

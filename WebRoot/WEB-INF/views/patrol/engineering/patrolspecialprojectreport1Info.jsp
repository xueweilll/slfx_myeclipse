...
<body>
	...
	<form id="ff" method="post" style="margin: 10px; text-align: center;">
		...
		<div id="btn">
			<a id="btnAdd" href="javascript:void(0)" onclick="add()"
				class="easyui-linkbutton" data-options="iconCls:'icon_add'">上报</a>&nbsp;&nbsp;
			<!-- <a id="btnAdd1"
	...
	<script type="text/javascript">
		function add() {
			...
			$.ajax({
				type : "POST",
				url : "psprojectreport1/save.html",
				dataType : "text",
				data : {
					"isid" : $("#isid").val()
				},
		...
		function reflush() {
			document.getElementById('psprojectreport1.htmlifm').contentWindow.$('#psprojectreport_list')
					.datagrid('reload');
			document.getElementById('psprojectreport1.htmlifm').contentWindow.$('#psprojectreport_list')

		...
		$(function(){
			...
			$("#sendList").datagrid({
				...
				onDblClickRow:function(index,row){
					showDialogWH("查看执行信息",
							"egpatroldepartmentsend/egpatroldepartmentsendInfo.html?isid=" + row.isid+"&look=1"+"&did="+row.did+"&regular=eg", "500", "400");
				} 
			});
			...
			$("#send").bind("click", function() {
				...
				var row = $("#sendList").datagrid("getSelected");
				 ...
				 showDialogWH("执行", "egpatroldepartmentsend/egpatroldepartmentsendInfo.html?isid=" + row.isid+"&look=0"+"&did="+row.did+"&regular=eg",500,400); 
				 } 
				});

...
<body>	
	<form id="ffemp" method="post" style="margin:10px; text-align: center;">
		...
		<div id="btn" style="text-align: center">
			<a id="sub" href="javascript:void(0)" class="easyui-linkbutton"
				data-options="iconCls:'icon-save'" onclick="Approval()">确定</a>&nbsp;&nbsp;<a id="cancel"
	...
	<script type="text/javascript">
		...
		function reflush() {
			document.getElementById('szpatrolApproval.htmlifm').contentWindow.$('#szpatrol')
					.datagrid('reload');
		}		
		function Approval(){
		      var id=$('#id').val();
		      $.post('szpatrolApproval/approval.html',{szid:id},function(msg){
		        if(msg=="true"){

...
<body>
	...
	<%-- 			  <td><select id="classes" class="easyui-combobox" name="state" style="width:280px;" data-options="editable:false,panelHeight:100" value="${patrolSpecialIssue.getClasses()} required="true" >
				...
				<tr>
					...
					<td><input id="content" style="width:280px"  data-options="multiline:true,height:70,required:true" class="easyui-textbox" value="${patrolSpecialIssue.getContent()}" /></td>
				</tr>
				<tr>
					<td>&nbsp;&nbsp;&nbsp;<label for="remark">备注:</label></td>
					<td><input id="remark" style="width:280px" data-options="multiline:true,height:70" class="easyui-textbox" value="${patrolSpecialIssue.getRemark()}" /></td>
				</tr>											
			</table>					 			 			 						 
		</div>
		</br>
	...
	<script type="text/javascript">
		...
		$("#sub").bind("click",function() {			
			...
			if($('#content').textbox('getText').replace(/\s+/g,"")==""){
				$.messager.alert("操作提示","请输入签发内容","");
				return false;
			}
			//console.info($('#classes').combobox('getValue'));
			var data={
				"id":$("#id").val()==""?"0":$("#id").val(),

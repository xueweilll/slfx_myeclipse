		...
		$(function(){
			...
			$("#Edit").click(function (){
				...
				if(Item==null){
					...
					showDialogWH("审批巡检记录", "regularpatrolspecialdepartmentreport/patrolnormaldepartmentInfo.html?patrolplandetailid="+stcds+"&isid="+Item.isid+"&look=0",800,600);
				}else if(Item.Levels=="已汇总"){
					$.messager.alert("操作提示","该记录已审批","info");
				}
			});
			...
			$("#patrolapproval").datagrid({
			    ...
			    toolbar:'#toolbar',
				columns : [ [ 
					/* { field : 'checked',hidden:true,width : 30,checkbox: true} , */
				...
				onCheck: function(index,row){
                   ...
                   // $.messager.alert("操作提示","请选择同一签发单编号","info");
					}
				},
			...
			/* 		if(data){
				...
				/*  if(row.Levels == '已汇总'){
					...
					showDialogWH("审批巡检记录", "regularpatrolspecialdepartmentreport/patrolnormaldepartmentInfo.html?patrolplandetailid="
						+row.id,800,600);
				 }  */
			 		showDialogWH("查看上报单", "regularpatrolspecialdepartmentreport/patrolnormaldepartmentInfo.html?patrolplandetailid="
							+row.id+"&isid="+row.isid+"&look=1",800,600);
				}
			}
        ...
        <div id="toolbar">
        	...
        	<div id="tool" style="" class="cz_div_title">
	        	<table>
	        		<tr>
	        			<td>
	        			<a class="easyui-linkbutton" data-options="iconCls:'icon-add'" id="Edit">审核</a>
	        			</td>
	        		</tr>    		
	        	</table>
        	</div>

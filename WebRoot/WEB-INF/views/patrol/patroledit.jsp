...
<body>
	<form id="ffemp" method="post" enctype="multipart/form-data"
		...
		<div style="width:600px;">
			<label for="patroltime" style="">巡检日期:</label> <input id="patroltime" style="text-align:left;width:200px;"
		...
		$(function() {
			...
			$('#approval').datagrid({
				...
				columns:[[
			        ...
			        {field:'enumid2',title:'巡检内容要求',width:500},
			        {field:'istype',title:'巡视检查记录',width:50},
			        {field:'contents',title:'问题记录',width:200},

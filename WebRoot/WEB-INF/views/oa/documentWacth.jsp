		...
		<table cellpadding="0" cellspacing="5" border="0">
			<tr>
				...
				<td><input id="level" class="easyui-combobox"
					data-options="required:true ,disabled:true" value="${document.getLevels()}"></td>
			</tr>
			...
			<tr>
				...
				<td><input id="title" class="easyui-combobox" name="title"
					style="width: 305px;"
					data-options="required:true,disabled:true"
			...
			<tr>
				...
				<td>
					<div id="fileList" name="fileList"
						style="border: 1px solid #ccc;"></div> <%-- <input id="textaddress"  class="easyui-textbox" value="${textaddress}"> --%>
		...
		$(function() {
			...
			if($("#ty").val() =="1"){
				...
				for(var i=0;i<s.length;i++){
					...
					+ id+"_"+s[i]+ "\")'>下载</a></div>";
					/* <a style='color:red;' href='javascript:deleteFile(\"" + id+"_"+s[i]
					+ "\","+k+",0)'>删除</a></div>"; */
					k++;
					console.info(str);
					$("#fileList").append(str);

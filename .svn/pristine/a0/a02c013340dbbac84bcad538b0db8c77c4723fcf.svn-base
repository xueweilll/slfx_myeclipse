...
<script>
		...
		$(function(){
			...
			$("#selfdispatch").datagrid({
				...
				url:'tenanceReviewList/tenanceReviewList.html',
				columns:[[
		...
		function agree(){
			...
			showDialogWH("复核单", "tenanceReviewList/tenanceReviewInfo.html?id="+row.id+"&projectName="+myEncoder(row.projectName)
	...
	<div id="cc" class="easyui-layout" style="width:100%;height:100%;">
		<div id="toolbar">
			...
			<div class="cz_div_title">
				<a id="forward" class="easyui-linkbutton"
					data-options="iconCls:'icon-add'" onclick="agree()">复核</a>
			</div>
			<div class="cz_div">
				编号:<input id="bh" class="easyui-textbox" name="bh"
					data-options="width:'160'"> 申请时间区间: <input id="starttime"

...
<body>
	...
	<div>		
		...
		<span align="center" style="font-size: 25;">回&nbsp;&nbsp;访&nbsp;&nbsp;单</span></p>
	</div>
	<form id="ff" method="post"
		...
		<div style="float: left;margin-top:2px">
			<label>调度令内容:</label><input class="easyui-textbox" id="rmemo"
		...
		<div style="float: left;">
			<div style="float: left;">
				<label>回访人:</label><input class="easyui-textbox" id="callbackpeople"
					data-options="required:true" style="width:230" value="" />
			</div>
			&nbsp;&nbsp;&nbsp;&nbsp;
			<div style="float:right;">
				<label>回访单位:</label><input id="callbackunit" class="easyui-textbox"
					data-options="required:true" style="width:230" value="" />
			</div>
		</div>
		<div style="float: left;">
			<div style="float: left;">
				<label>操作人:</label><input id="operater" name="operater" style="width:230" value="" />
			</div>
			&nbsp;&nbsp;&nbsp;&nbsp;
			<div style="float: right;">
				<label>回访时间:</label><input id="callbacktime" name="callbacktime"
					style="width:230;" value="" />
			</div>
		</div>
		<div style="float: left;margin-top:2px;margin-bottom:5px;">
			<label>回访内容:</label><input class="easyui-textbox" id="callback"
	...
	<script type="text/javascript">
			...
			$("#save").bind(
					...
					function() {
						...
						var data = {
							"rdid" : ($("#did").val() == "" ? 0 : $("#did")
									.val()),
							"callbackpeople" : $("#callbackpeople").textbox(
									"getValue"),
							"callback" : $("#callback").textbox("getValue").replace(/\s+/g,""),
							"callbackunit" : $("#callbackunit").textbox(
									"getValue"),
							"operater" : $("#operater").combobox("getValue"),
							"callbacktime" : $("#callbacktime").datetimebox(
									"getValue")
						};
						$.ajax({
							type : "POST",
							url : "callback/save.html",
							dataType : "text",
							data : {
		...
		function reflush() {
			document.getElementById('callback.htmlifm').contentWindow

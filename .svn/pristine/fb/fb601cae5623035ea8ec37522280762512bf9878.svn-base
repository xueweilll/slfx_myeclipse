...
import com.benqzl.core.BufferedImageLuminanceSource;
...
public class QRCodeUtil {
    ...
    public static void encode(String content, String imgPath, String destPath,
            boolean needCompress,String code) throws Exception {
    ...
    public static void main(String[] args) throws Exception {
        String text = "http://192.168.1.84:8080/slfx/qrcode.html?id=1111";
        QRCodeUtil.encode(text,null,"d:/MyWorkDoc",false,"AAAAA");
    }

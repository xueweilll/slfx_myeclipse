	...
	<script>
		...
		$(function(){
			...
			$("#selfdispatch").datagrid({
				url:'dispatchIssuedList/dispatchIssuedList.html',		
				queryParams: {
					typeDate:"0"
				},
				columns:[[	       			        
			        {field:'code',title:'执行单编号',width:'120px',hidden:true},
			        {field:'name',title:'执行部门',width:'140px'},
			        {field:'departmentid',hidden:true},
			        {field:'promotetime',title:'执行时间',width:'140px'},
			        {field:'username',title:'执行发起人',width:'130px'},
			        //{field:'memo',title:'调度备注',width:'200px'},
			        {field:'creater',title:'制单人',width:'130px'},
			        {field:'createtime',title:'制单时间',width:'140px'},
			        {field:'sender',title:'下发人',width:'130px'},
			        {field:'sendertime',title:'下发时间',width:'140px'},
			        {field:'state',title:'状态',width:'140px'},
			    ]],
			    toolbar:'#toolbar',
			    pageSize : 20,
			    width : 'auto',
				...
				fit : true,onDblClickRow:function(index,row){				
					showDialogWH("查看执行单信息", "dispatchIssuedList/dispatchIssuedInfo.html?id="+row.id+"&state=1"+"&departmentid="+row.departmentid,500,600);
				}
			});
		...
		function Add(){
			...
			showDialogWH("查看执行单信息", "dispatchIssuedList/dispatchIssuedInfo.html?id="+row.id+"&state=0&departmentid="+ row.departmentid,500,600);
		}
		function selectbig(){
			$("#selfdispatch").datagrid('unselectAll');
  ...
  <body class="easyui-layout" id="cc">
    ...
    <div id="cc" class="easyui-layout" style="width:100%;height:100%;">
        ...
        <div id="tt" class="easyui-tabs" style="">
        	...
        	<a id="adds"  class="easyui-linkbutton" data-options="iconCls:'icon-add'" onclick="Add()">执行</a>
        	</div>
        	<div  class="cz_div">
        	<div style="display:none;">  
        	执行单编号:&nbsp;<input id="code" class="easyui-textbox" style="width: 120px"> &nbsp;&nbsp; 
        	</div>
        	执行时间:&nbsp;<input id="begintime" style="width: 160px"/> ~ 

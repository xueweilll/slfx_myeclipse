...
<script type="text/javascript">
	...
	function add() {
		showDialogWH("添加物资入库", "inStorage/inStorageInfo.html?id=0",650,510);
	}
	...
	function edit() {
		...
		showDialogWH("编辑物资入库", "inStorage/inStorageInfo.html?id=" + row.id,650,520);
	}
	...
	function commit(){
		...
		showDialogWH("提交入库单", "inStorage/inStorageInfo.html?id=" + row.id+"&type=1",650,550);
	}
	function searchInfo(row){
		showDialogWH("查看入库明细", "inStorage/inStorageInfo.html?id=" + row.id+"&type=0",650,550);
	}
...
<body class="easyui-layout" id="cc">
	<table id="inStorage_list" cellspacing="0" cellpadding="0"></table>
		...
		<div class="cz_div">
			...
			入库编号:<input id="code" class="easyui-textbox" name="code"   

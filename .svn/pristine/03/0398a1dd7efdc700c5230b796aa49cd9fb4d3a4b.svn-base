...
* @Description: TODO(物资出库操作) 
* @author 冯庆国
* @date 2016年1月25日 下午4:18:21 
*  
*/
@Controller
@RequestMapping("outStorage")
public class OutStorageController extends BasicController{
	...
	public OutStorageController() {
		super(OutStorageController.class);
		// TODO Auto-generated constructor stub
	}
	/** 
	* @Title: index 
	* @Description: TODO(物资出库首页) 
	* @param @return    设定文件 
	...
	*/
	...
	public ModelAndView index() {
		...
		mv.setViewName("/material/outStorage");
		return mv;
	}
	
	/** 
	* @Title: outStorageInfo 
	* @Description: TODO(物资出库新增、编辑、提交、查询) 
	* @param @param id
	* @param @param type
	* @param @return    设定文件 
	* @return ModelAndView    返回类型 
	...
	*/
	...
	@RequestMapping(value = "outStorageInfo", method = RequestMethod.GET)
	public ModelAndView outStorageInfo(String id,String type) {
		ModelAndView mv = new ModelAndView();
		...
		if(!id.equals("0")){
			...
			stock.setCode(activitiUnitService.selectMaxCode("CK"));
		}
		...
		mv.setViewName("/material/outStorageInfo");
		return mv;
	}
	
	/** 
	* @Title: bind 
	* @Description: TODO(物资出库首页数据绑定) 
	* @param @param page
	* @param @param rows
	* @param @param code
	...
	*/
	...
	public String commit(String id){
		...
		try {
			...
			materialIds=storageService.outStorage(items,"1");
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();

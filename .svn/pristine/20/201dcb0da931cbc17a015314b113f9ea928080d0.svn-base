...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#inStorage_list").datagrid({
			...
			collapsible : false,
			fit : true,
			url : 'inStockTable/stockTable.html',
			idField : 'id',
			singleSelect : true,
			pagination : true,
			rownumbers : true,
			...
			columns:[[    
			          ...
			          {field:'count',title:'数量',width:140},    
			          {field:'type',title:'类型',width:140},     
			          {field:'oldstorage',title:'原库存',width:200},
			          {field:'newstorage',title:'现库存',width:200},
			          {field:'creatertime',title:'入库时间',width:160},
...
<body class="easyui-layout" id="cc">
	<table id="inStorage_list" cellspacing="0" cellpadding="0"></table>
		...
		<div style="margin-bottom:5px" class="cz_div">
			...
			入库类型:<input id="types" class="easyui-combobox" name="types"   
    				data-options="width:'160'"/>
			入库时间区间: <input id="starttime" type="text" data-options="width:160,editable:false,buttons: buttons">

		...
		<div>
		 ...
		 <form id="ffemp" method="post" style="margin:10px; text-align: center;">
			    ...
			    <%--<td><input id="classes" style="width:300px" class="easyui-combobox"  value="${patrolSpecialIssue.getClasses}" /></td> --%>
				  <td><select id="classes" class="easyui-combobox" name="state" disabled="disabled" style="width:280px;" data-options="editable:false,panelHeight:100" value="${patrolSpecialIssue.getClasses()} required="true" >
							<option value="0" data-options="editable:false" disabled="true">汛前</option>
							<option value="1" data-options="editable:false" disabled="true">汛期</option>
							<option value="2" data-options="editable:false" disabled="true">汛后</option>
							 <option value="3" data-options="editable:false">特别检查</option>
				</tr>
				<tr>

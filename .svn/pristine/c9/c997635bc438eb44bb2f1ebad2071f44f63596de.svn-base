 ...
 */
@Controller
@RequestMapping("patrolSpecialmanagement1")
public class PatrolSpecialmanagement1Controller extends BasicController {
	...
	public PatrolSpecialmanagement1Controller() {
		super(PatrolSpecialmanagement1Controller.class);
	}
	...
	public ModelAndView index() {
		...
		mv.setViewName("patrol/management/patrolSpecialmanagement1");
		return mv;
	}
	 ...
	 * @throws
	 */
	@RequestMapping(value = "patrolSpecialmanagement1Info", method = RequestMethod.GET)
	@ResponseBody
	public ModelAndView patrolSpecialmanagement1Info(String type,String isId) {
		...
		mv.setViewName("patrol/management/patrolSpecialmanagement1Info");
		return mv;
	}

	...
	<script>
		...
		$(function(){
			...
			$("#selfdispatch").datagrid({
				...
				url:'tenanceAduitList/tenanceAduitList.html',
				columns:[[
		...
		function agree(){
			...
			showDialogWH("审批单", "tenanceAduitList/tenanceAduitInfo.html?id="+row.id+"&projectName="+myEncoder(row.projectName)
    ...
    <div id="cc" class="easyui-layout" style="width:100%;height:100%;">
        <div id="toolbar">      	       	
        	...
        	<div class="cz_div_title">
        			<a id="forward"  class="easyui-linkbutton" data-options="iconCls:'icon-add'" onclick="agree()">审批</a>      			    
    				</div>
    				<div class="cz_div">

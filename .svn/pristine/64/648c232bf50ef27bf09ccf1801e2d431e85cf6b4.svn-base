...
<script>
		...
		$(function(){
			...
			$("#selfdispatch").datagrid({
				url:'sdApproval/sdApprovalList.html',		
				queryParams: {
					typeDate:"0"
				},
				columns:[[	       			        
			        {field:'code',title:'调度令编号',width:'120px',hidden:true},
			        {field:'promotetime',title:'调度发起时间',width:'140px'},
			        {field:'username',title:'调度发起人',width:'130px'},
			        {field:'creater',title:'制单人',width:'130px'},
			        {field:'createtime',title:'制单时间',width:'140px'},
			        {field:'approval',title:'审批人',width:'130px'},
			        {field:'approvaltime',title:'审批时间',width:'140px'}
			    ]],
			    toolbar:'#toolbar',
			    pageSize : 20,
			    width : 'auto',
				...
				fit : true,onDblClickRow:function(index,row){				
					showDialogWH("查看调度令信息", "sdApproval/sdApprovalInfo.html?id="+row.id+"&state=1",500,475);
				}
			});
		...
		function Add(){
			...
			showDialogWH("查看调度令信息", "sdApproval/sdApprovalInfo.html?id="+row.id+"&state=0",500,475);
		}
		function selectbig(){
			$("#selfdispatch").datagrid('unselectAll');
   ...
   <body class="easyui-layout" id="cc">
    ...
    <div id="cc" class="easyui-layout" style="width:100%;height:100%;">
        ...
        <div id="tt" class="easyui-tabs" style="">
        	...
        	<a id="adds"  class="easyui-linkbutton" data-options="iconCls:'icon-add'" onclick="Add()">审批</a>
        	</div>
        	<div  class="cz_div">
        	<div style="display:none;">  
        	调度令编号:&nbsp;<input id="code" class="easyui-textbox" style="width: 120px"> &nbsp;&nbsp;
        	</div> 
        	调度发起时间:&nbsp;<input id="begintime" style="width: 160px"/> ~ 

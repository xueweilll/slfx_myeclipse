package com.benqzl.controller.patrol.management;
 ...
 */
@Controller
@RequestMapping("patrolSpecialmanagement")
public class PatrolSpecialmanagementController extends BasicController {
	...
	public PatrolSpecialmanagementController() {
		super(PatrolSpecialmanagementController.class);
	}
	...
	public ModelAndView index() {
		...
		mv.setViewName("patrol/management/patrolSpecialmanagement");
		return mv;
	}
	 ...
	 * @throws
	 */
	@RequestMapping(value = "patrolSpecialmanagementInfo", method = RequestMethod.GET)
	@ResponseBody
	public ModelAndView patrolSpecialmanagementInfo(String type,String isId) {
		...
		mv.setViewName("patrol/management/patrolSpecialmanagementInfo");
		return mv;
	}
	...
	public String save(String isid) {
		...
		try {
			...
			e.printStackTrace();
			return "{'result':false,'msg':'审阅失败！'}";
		}
		return "{'result':true,'msg':'审阅成功！'}";
	}
}

...
/** 
* @ClassName: CheckOutStorageController 
* @Description: TODO(物资外借操作) 
* @author 冯庆国
* @date 2016年1月25日 下午4:11:48 
*  
*/
@Controller
@RequestMapping("checkOutStorage")
public class CheckOutStorageController extends BasicController{
	...
	public CheckOutStorageController() {
		super(CheckOutStorageController.class);
		// TODO Auto-generated constructor stub
	}
	/** 
	* @Title: index 
	* @Description: TODO(物资外借首页) 
	* @param @return    设定文件 
	...
	*/
	...
	public ModelAndView index() {
		...
		mv.setViewName("/material/checkOutStorage");
		return mv;
	}
	
	/** 
	* @Title: checkOutStorageInfo 
	* @Description: TODO(物资外借新增、查询、提交、编辑) 
	* @param @param id
	* @param @param type
	* @param @return    设定文件 
	* @return ModelAndView    返回类型 
	...
	*/
	...
	@RequestMapping(value = "checkOutStorageInfo", method = RequestMethod.GET)
	public ModelAndView checkOutStorageInfo(String id,String type) {
		ModelAndView mv = new ModelAndView();
		...
		if(!id.equals("0")){
			...
			stock.setCode(activitiUnitService.selectMaxCode("WJ"));
		}
		...
		mv.setViewName("/material/checkOutStorageInfo");
		return mv;
	}
	
	/** 
	* @Title: bind 
	* @Description: TODO(物资外借首页数据绑定) 
	* @param @param page
	* @param @param rows
	* @param @param code
	...
	public String selectStockItems(String id){
		...
		gson = new GsonBuilder().registerTypeAdapter(StockItems.class, new JsonSerializer<StockItems>() {
			...
			public JsonElement serialize(StockItems arg0, Type arg1,
				...
				json.addProperty("surplusCount", arg0.getSurpluscount());
	...
	*/
	...
	public String commit(String id){
		...
		try {
			...
			materialIds=storageService.outStorage(items,"2");
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();

...
/** 
* @ClassName: ProfitAndLossStorageController 
* @Description: TODO(物资损益操作) 
* @author 冯庆国
* @date 2016年1月25日 下午4:20:23 
*  
*/
@Controller
@RequestMapping("profitAndLossStorage")
public class ProfitAndLossStorageController extends BasicController{
	@Autowired
	private StockService service;

	public ProfitAndLossStorageController() {
		super(ProfitAndLossStorageController.class);
		// TODO Auto-generated constructor stub
	}
	
	/** 
	* @Title: index 
	* @Description: TODO(损益增删改查页面) 
	* @param @return    设定文件 
	...
	*/
	...
	public ModelAndView index() {
		...
		mv.setViewName("/material/profitAndLossStorage");
		return mv;
	}
	
	/** 
	* @Title: profitAndLossStorageInfo 
	* @Description: TODO(物资损益新增、编辑、查询、提交) 
	* @param @param id
	* @param @param type
	* @param @return    设定文件 
	* @return ModelAndView    返回类型 
	...
	*/
	...
	@RequestMapping(value = "profitAndLossStorageInfo", method = RequestMethod.GET)
	public ModelAndView profitAndLossStorageInfo(String id,String type) {
		ModelAndView mv = new ModelAndView();
		...
		if(!id.equals("0")){
			...
			stock.setCode(activitiUnitService.selectMaxCode("XY"));
		}
		...
		mv.setViewName("/material/profitAndLossStorageInfo");
		return mv;
	}
	
	/** 
	* @Title: bind 
	* @Description: TODO(物资损益首页数据绑定) 
	* @param @param page
	* @param @param rows
	* @param @param code
	...
	*/
	...
	public String commit(String id){
		...
		try {
			...
			materialIds=storageService.profitAndLossStorage(items);
		} catch (Exception e) {
			e.printStackTrace();

...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#psprojectreport_list").datagrid({
			...
			collapsible : false,
			fit : true,
			url : 'psprojectreport1/bind.html',
			idField : 'id',
			singleSelect : true,
			queryParams: {
				typeDate : 0
			...
			columns:[[    
			          ...
			          {field:'classes',title:'类型',width:120},    
	...
	function commit(){
		...
		showDialogWH("提交签发单", "psprojectreport1/patrolspecialprojectreport1Info.html?isId=" + row.id+"&type=1",670,590);
	}
	function searchInfo(row){
		showDialogWH("查看签发单明细", "psprojectreport1/patrolspecialprojectreport1Info.html?isId=" + row.id+"&type=0",670,590);
	}
...
<body class="easyui-layout" id="cc">
	<table id="psprojectreport_list" cellspacing="0" cellpadding="0"></table>
		...
		<div class="cz_div">
			<a  id="commit"  href="javascript:void(0)" class="easyui-linkbutton" onclick="commit()" iconCls="icon_commit" plain="false">上报</a>&nbsp;&nbsp;&nbsp;&nbsp;

...
public interface SzPatrolMapper {
    int deleteByPrimaryKey(String id);

    int insert(SzPatrol record);

    int insertSelective(SzPatrol record);

    SzPatrol selectByPrimaryKey(String id);

    int updateByPrimaryKeySelective(SzPatrol record);

    int updateByPrimaryKey(SzPatrol record);

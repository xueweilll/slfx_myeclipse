...
public class PatrolReportController extends BasicController{
	
	@Autowired
	private DepartmentPatrolService service;
	
	public PatrolReportController() {
		super(PatrolReportController.class);
	}
	...
	*/
	...
	public ModelAndView index(){
		...
		mv.setViewName("patrol/patrolReport");
		return mv;
	}
	...
	* @throws 
	*/
	@RequestMapping(value="patrolReportInfo",method=RequestMethod.GET)
	public ModelAndView patrolReportInfo(String jsonStr){
		gson = new Gson();
		...
		mv.setViewName("patrol/patrolReportInfo");
		return mv;
	}
	/** 
	* @Title: bind 

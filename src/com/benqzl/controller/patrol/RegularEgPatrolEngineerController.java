 ...
 */
@Controller
@RequestMapping("regularegpatrolengineer")
public class RegularEgPatrolEngineerController extends BasicController {

	public RegularEgPatrolEngineerController() {
		super(RegularEgPatrolEngineerController.class);
	}
	...
	public ModelAndView index() {
		...
		mv.setViewName("patrol/regularegpatrolengineer");
		return mv;
	}
	...
	public ModelAndView info(String id, Model model) throws Exception {
		...
		mv.setViewName("patrol/regularegpatrolengineerInfo");
		return mv;
	}
	...
	public ModelAndView infoHide(String id, Model model) throws Exception {
		...
		PatrolSpecialResolve patrolSpecialResolve=patrolSpecialResolveService.findegpatrolById(id);
		model.addAttribute("resolveInfo", patrolSpecialResolve);
		mv.setViewName("patrol/regularegpatrolengineerInfoHide");
		return mv;
	}
	...
	public String egpatrolengineerlist(int rows, int page,String starttime, String endtime,String typeDate,String type) throws Exception {
		...
		List<PatrolSpecialIssue> list = patrolSpecialIssueService.selectRegularEgpatrolByPage(map);
		Map<String, Object> jsonMap = new HashMap<String, Object>();
		int total = patrolSpecialIssueService.regularPageCount(map);

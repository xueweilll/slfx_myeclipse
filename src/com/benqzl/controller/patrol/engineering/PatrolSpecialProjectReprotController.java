 ...
 */
@Controller
@RequestMapping("psprojectreport")
public class PatrolSpecialProjectReprotController extends BasicController {
	...
	public PatrolSpecialProjectReprotController() {
		super(PatrolSpecialProjectReprotController.class);
	}
	...
	public ModelAndView index() {
		...
		mv.setViewName("patrol/engineering/patrolspecialprojectreport");
		return mv;
	}
	 ...
	 * @throws
	 */
	@RequestMapping(value = "patrolspecialprojectreportInfo", method = RequestMethod.GET)
	@ResponseBody
	public ModelAndView patrolspecialprojectreportInfo(String type,String isId) {
		...
		mv.setViewName("patrol/engineering/patrolspecialprojectreportInfo");
		return mv;
	}

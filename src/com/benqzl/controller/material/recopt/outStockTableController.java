...
/**
 * @ClassName: outStockTableController
 * @Description: TODO(出库报表)
 * @author pxj
 * @date 2016年1月27日 下午12:38:03
 * 
 */
@Controller
@RequestMapping("outStockTable")
public class outStockTableController extends BasicController {

	@Autowired
	private TableService service;

	public outStockTableController() {
		super(inStockTableController.class);
	}

	/**
	 * @Title: index
	 * @Description: TODO(出库查页面)
	 * @param @return 设定文件
	...
	public ModelAndView index() {
		...
		mv.setViewName("/material/outStockTable");
		return mv;
	}
	...
	public String stockTable(int page, int rows, String starttime,
		...
		if (typeDate != null && typeDate.equals("9")) {
				...
				new JsonSerializer<MaterialManage>() {
					...
					public JsonElement serialize(MaterialManage arg0,
						...
						if(arg0.getTypedate()==1){
							...
							type="外借出库";
						}else if(arg0.getTypedate()==3){
							type="调拨出库";
						}else{
							type="损失出库";
						}
						json.addProperty("types", type);

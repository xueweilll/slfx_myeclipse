...
/** 
* @ClassName: ScrapStorageController 
* @Description: TODO(物资报废操作) 
* @author 冯庆国
* @date 2016年1月25日 下午4:22:34 
*  
*/
@Controller
@RequestMapping("scrapStorage")
public class ScrapStorageController extends BasicController{
	...
	public ScrapStorageController() {
		super(ScrapStorageController.class);
		// TODO Auto-generated constructor stub
	}
	/** 
	* @Title: index 
	* @Description: TODO(物资报废首页面) 
	* @param @return    设定文件 
	...
	*/
	...
	public ModelAndView index() {
		...
		mv.setViewName("/material/scrapStorage");
		return mv;
	}
	
	/** 
	* @Title: scrapStorageInfo 
	* @Description: TODO(物资报废新增、查询、编辑、提交) 
	* @param @param id
	* @param @param type
	* @param @return    设定文件 
	* @return ModelAndView    返回类型 
	...
	*/
	...
	@RequestMapping(value = "scrapStorageInfo", method = RequestMethod.GET)
	public ModelAndView scrapStorageInfo(String id,String type) {
		ModelAndView mv = new ModelAndView();
		...
		if(!id.equals("0")){
			...
			stock.setCode(activitiUnitService.selectMaxCode("BF"));
		}
		...
		mv.setViewName("/material/scrapStorageInfo");
		return mv;
	}
	
	/** 
	* @Title: bind 
	* @Description: TODO(物资报废首页数据绑定) 
	* @param @param page
	* @param @param rows
	* @param @param code
	...
	*/
	...
	public String commit(String id){
		...
		try {
			...
			materialIds=storageService.outStorage(items,"4");
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();

...
* @Description: TODO(物资入库操作) 
* @author 冯庆国
* @date 2016年1月25日 下午4:16:27 
*  
*/
@Controller
@RequestMapping("inStorage")
public class InStorageController extends BasicController{
	...
	public InStorageController() {
		super(InStorageController.class);
		// TODO Auto-generated constructor stub
	}
	/** 
	* @Title: index 
	* @Description: TODO(物资入库首页) 
	* @param @return    设定文件 
	...
	*/
	...
	public ModelAndView index() {
		...
		mv.setViewName("/material/inStorage");
		return mv;
	}
	
	/** 
	* @Title: inStorageInfo 
	* @Description: TODO(物资入库新增、查询、提交、编辑) 
	* @param @param id
	* @param @param type
	* @param @return    设定文件 
	* @return ModelAndView    返回类型 
	...
	*/
	...
	@RequestMapping(value = "inStorageInfo", method = RequestMethod.GET)
	public ModelAndView inStorageInfo(String id,String type) {
		ModelAndView mv = new ModelAndView();
		...
		if(!id.equals("0")){
			...
			stock.setCode(activitiUnitService.selectMaxCode("RK"));
		}
		...
		mv.setViewName("/material/inStorageInfo");
		return mv;
	}
	
	/** 
	* @Title: bind 
	* @Description: TODO(物资入库首页数据绑定) 
	* @param @param page
	* @param @param rows
	* @param @param code
	...
	*/
	...
	/** 
	* @Title: commitInStorage 
	* @Description: TODO(物资入库提交) 
	* @param @param id
	* @param @return    设定文件 
	* @return String    返回类型 
	* @throws 
	*/
	...
	@ResponseBody
	public String commitInStorage(String id){
		boolean result = false;
		try {
			List<StockItems> items = service.selectItemsByStockId(id);
			result = storageService.inStorage(items,"1");
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
